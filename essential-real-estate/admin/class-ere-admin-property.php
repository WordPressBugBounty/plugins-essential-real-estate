...
if ( ! class_exists( 'ERE_Admin_Property' ) ) {
	...
	class ERE_Admin_Property {
		...
		public function display_custom_column( $column ) {
			...
			switch ( $column ) {
				case 'thumb':
					...
					break;
				case 'type':
                    echo wp_kses_post(ere_admin_taxonomy_terms( $post->ID, 'property-type', 'property' ));
					break;
				case 'status':
					echo wp_kses_post(ere_admin_taxonomy_terms( $post->ID, 'property-status', 'property' ));
					break;
				case 'price':
				...
				case 'featured':
					...
					$url = wp_nonce_url( admin_url( 'admin-ajax.php?action=ere_admin_feature_property&id=' . $post->ID ), 'ere_featured_property' );
			...
			if ( $typenow == $post_type ) {
				...
				foreach ( $taxonomy_arr as $taxonomy ) {
					...
					wp_dropdown_categories( array(
						...
						'show_option_all' => sprintf( esc_html__( 'All %s', 'essential-real-estate' ),  $info_taxonomy->label ),
						'taxonomy'        => $taxonomy,
						'name'            => $taxonomy,
						'orderby'         => 'name',
						'selected'        => $selected,
		...
		public function feature() {
            check_ajax_referer('ere_featured_property');
